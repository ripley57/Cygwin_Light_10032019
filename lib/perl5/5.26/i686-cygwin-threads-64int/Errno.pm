...
"i686-cygwin-threads-64int-multi-2.11.2(0.32953)" or
	die "Errno architecture (i686-cygwin-threads-64int-multi-2.11.2(0.32953)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
